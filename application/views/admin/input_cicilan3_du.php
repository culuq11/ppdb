                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-8 form-group">
                                    <div class="form-group position-relative has-icon-right">
                                        <!-- <input type="number" class="form-control" name="c2_du" id="c2_du" autocomplete="off" value="<?= $getPembayaran['cicilan_kedua']; ?>" readonly onkeyup="sum();"> -->
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-8 form-group">
                                    <div class="form-group position-relative has-icon-right">
                                        <!-- <input type="number" class="form-control" name="c3_du" id="c3_du" autocomplete="off" value="<?= $getPembayaran['cicilan_ketiga']; ?>" onkeyup="sum();"> -->
                                    ...
                                    <!-- <?= form_error('c3_du', '<div class="alert alert-danger alert-dismissible show fade"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>', '</div>'); ?> -->
                                    <?= form_error('cicilan_3', '<div class="alert alert-danger alert-dismissible show fade"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>', '</div>'); ?>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-between">
                                        <a href="<?= base_url('admin/input_du'); ?>" type="submit" class="btn btn-warning">Kembali</a>
