        ...
        <div class="card-header">
            <div>
                <div class="d-flex justify-content-between">
                    ...
                    <span class="float-right h6 text-dark"><?= date('d M Y H:i:s', $getPembayaran['tgl_bayar_lunas']); ?></span>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-lg-9 col-8">
                            <h5><i class="text-dark"><u><?= terbilang($getPembayaran['total_bayar']); ?> Rupiah</u></i></h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-lg-4 col-4">
                            <input type="text" class="form-control" value="<?= number_format($getPembayaran['total_bayar'], 0, ',', '.'); ?> ,-" readonly>
                        </div>
                    </div>
                </div>
            </div>
