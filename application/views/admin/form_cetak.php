                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="text-center">
                                ...
                                <div class="h3 font-weight-300">
                                    <?= $getSiswa['tempat_lahir']; ?>, <?= $getSiswa['tgl_lahir']; ?>
                                </div>
                                <div class="h3 mt-4">
                                    Kompetensi Keahlian yang Dipilih :
                                    <!-- <?= $getSiswa['asal_sekolah']; ?> -->
                                </div>
                                <div class="h3 font-weight-300">
                                    <?php foreach ($jurusan as $j) : ?>
                                        <?php if ($j['id'] == $getSiswa['jurusan_id']) : ?>
                                            <?= $j['komp_keahlian']; ?>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php if ($getSiswa['nama_verifikator'] == '') : ?>
                                <div class="pl-lg-4">
                                    <div class="d-flex justify-content-between">
                                        <h4>No. Registrasi : <strong><?= $getSiswa['no_reg']; ?></strong></h4>
                                        <h4 class="float-right">Waktu Pendaftaran : <strong><?= date('d M Y H:i:s', $getSiswa['tgl_buat']); ?></strong></h4>
                                    </div>
                                </div>
                            <?php else : ?>
                                <div class="pl-lg">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <h6>Verifikator : <strong><?= $getSiswa['nama_verifikator']; ?> || <?= $getSiswa['status_verifikator']; ?></strong></h6>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <div class="pl-lg-4">
                                ...
                                <div class="table-responsive">
                                    <table class="table align-items-center table-dark table-flush">
                                        ...
                                        <tbody class="list">
                                            <tr>
                                                <th scope="col"><?= $getSiswa['nisn']; ?></th>
                                                <th scope="col"><?= $getSiswa['nama_ayah']; ?></th>
                                                <th scope="col"><?= $getSiswa['nama_ibu']; ?></th>
                                                <th scope="col"><?= $getSiswa['asal_sekolah']; ?></th>
                                                <th scope="col"><?= $getSiswa['alamat_regis']; ?></th>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
