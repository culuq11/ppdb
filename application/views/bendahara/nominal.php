            ...
            <div class="row match-height">
                <div class="col-6">
                    <div class="card">
                        ...
                        <form action="<?= base_url('bendahara/nominal_du'); ?>" method="POST">
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-md-4">
            ...
            <div class="row match-height">
                <div class="col-6">
                    <div class="card">
                        ...
                        <form action="<?= base_url('bendahara/nominal_seragam'); ?>" method="POST">
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <label>Nominal Biaya</label>
                ...
                <div class="col-6">
                    <div class="card">
                        ...
                        <form action="<?= base_url('bendahara/nominal_seragam2'); ?>" method="POST">
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <label>Nominal Biaya</label>
