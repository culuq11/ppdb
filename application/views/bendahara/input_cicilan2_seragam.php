                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-8 form-group">
                                    <div class="form-group position-relative has-icon-right">
                                        <!-- <input type="number" class="form-control" name="c2_seragam" id="c2_seragam" autocomplete="off" value="<?= $getPembayaran['cicilan_kedua']; ?>" onkeyup="sum();"> -->
                                    ...
                                    <!-- <?= form_error('c2_seragam', '<div class="alert alert-danger alert-dismissible show fade"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>', '</div>'); ?> -->
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-8 form-group">
                                    <div class="form-group position-relative has-icon-right">
                                        <!-- <input type="number" class="form-control" name="c3_seragam" id="c3_seragam" autocomplete="off" value="<?= $getPembayaran['cicilan_ketiga']; ?>" readonly onkeyup="sum();"> -->
