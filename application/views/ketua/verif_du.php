                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- <div class="row">
                                <div class="col-6">
                                    <a href="#" class="col-md-12 btn btn-outline-primary rounded-pill">Primary</a>
                                </div>
                                <div class="col-6">
                                    <a href="#" class="col-md-12 btn btn-outline-success rounded-pill">Success</a>
                                </div>
                            </div> -->
                                                ...
                                                <?php if ($biaya['total_bayar'] >= $biaya_DU['nominal_du']) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="badge bg-info">Belum Masuk MPLS</i></span>
                                                        </td>
                                                    </tr>
        ...
        <div class="modal fade text-left" id="masuk_mpls<?= $biaya['id_bayar']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('ketua/verif_du') ?>" method="POST">
