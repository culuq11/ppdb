            ...
            <div class="col-lg-10 col-md-8">
                <div class="card bg-secondary border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form method="post" action="<?= base_url('auth/regis_verifikator'); ?>">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input class="form-control" type="hidden" name="kode_reg" id="kode_reg" value="<?= $kode_verifikator; ?>">
                                        <label>NISN</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge input-group-alternative">
                                            ...
                                            <input class="form-control" placeholder="Nama Verifikator" type="text" name="nama_verifikator" id="nama_verifikator" autocomplete="off" value="<?= set_value('nama_verifikator'); ?>">
                                        </div>
                                        <?= form_error('nama_verifikator', '<div class="alert alert-danger sukses alert-dismissible fade show" role="alert">
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                        </button>', '</div>'); ?>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Status Verifikator</label>
                                        <!-- <select class="form-control" name="status_verifikator" id="status_verifikator">
                                            <option value="">=== Pilih Status Verifikator ===</option>
                                            <?php foreach ($status_verif as $sv) : ?>
                                        ...
                                        <div class="input-group input-group-merge input-group-alternative">
                                            ...
                                            <input class="form-control" placeholder="Status Verifikator" type="text" name="status_verifikator" id="status_verifikator" autocomplete="off" value="<?= set_value('status_verifikator'); ?>">
                                        </div>
                                        <p class="text-danger">* <strong><em>Isilah status Verifikator dengan keterangan Guru ..... / Siswa Kelas .... / Keterangan Lainnya.</em></strong></p>
                                        <?= form_error('status_verifikator', '<div class="alert alert-danger sukses alert-dismissible fade show" role="alert">
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                        </button>', '</div>'); ?>
                                    </div>
