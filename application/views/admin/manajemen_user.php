                                    ...
                                    <?php foreach ($pengguna as $user) : ?>
                                        <?php if ($user['status_user'] != 'Super Admin') : ?>
                                            <tr>
                                                ...
                                                <td><?= $user['role']; ?></td>
                                                <td>
                                                    <a href="<?= base_url('admin/detail_user/') . $user['id_user']; ?>" class="badge bg-success"><i class="fas fa-user-check"></i></a>
                                                    <a href="" class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#hapus_user<?= $user['id_user']; ?>"><i class="fas fa-trash-alt"></i></a>
                                                    <!-- <?= base_url('admin/hapus_user/') . $user['id_user']; ?> -->
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
    ...
    <div class="modal fade text-left w-100" id="tambah_user" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/manajemen_user'); ?>" method="POST">
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?= base_url('admin/hapus_user/') . $user['id_user']; ?>" class="btn btn-success ml-1">
                            <i class="bx bx-check d-block d-sm-none"></i>
