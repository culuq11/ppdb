<div class="page-content">
    ...
    <form action="<?= base_url('admin/input_seragam'); ?>" method="POST">
                                            ...
                                            <td class="text-center">
                                                <?php if ($seragam['jenis_kelamin'] == 'Laki-Laki') : ?>
                                                    <?php if ($seragam['total_bayar'] >= $biaya_seragam['nominal_seragam']) : ?>
                                                        ...
                                                        <a href="<?= base_url('admin/kwitansi_lunas/') . $seragam['id_bayar']; ?>" class="badge bg-info" target="_blank">Kwi. Lunas</i></a>
                                                        <a href="<?= base_url('admin/kwitansi_ci3/') . $seragam['id_bayar']; ?>" class="badge bg-info" target="_blank">Kwi. Cicilan 3</i></a>
                                                    ...
                                                    <?php elseif ($seragam['total_bayar'] <= $biaya_seragam['nominal_seragam']) : ?>
                                                        <?php if ($seragam['cicilan_kedua'] == '0') : ?>
                                                            ...
                                                            <a href="<?= base_url('admin/cicilan2_seragam/') . $seragam['id_bayar']; ?>" class="badge bg-warning">Cicilan 2</a>
                                                            <a href="<?= base_url('admin/kwitansi_ci1/') . $seragam['id_bayar']; ?>" class="badge bg-info" target="_blank">Kwi. Cicilan 1</i></a>
                                                            <a href="" class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#hapus_bayar<?= $seragam['id_bayar']; ?>"><i class="fas fa-trash-alt"></i></a>
                                                        <?php elseif ($seragam['cicilan_ketiga'] == '0') : ?>
                                                            <span class="badge bg-secondary">Belum Lunas</span>
                                                            <a href="<?= base_url('admin/cicilan3_seragam/') . $seragam['id_bayar']; ?>" class="badge bg-warning">Cicilan 3</a>
                                                            <a href="<?= base_url('admin/kwitansi_ci2/') . $seragam['id_bayar']; ?>" class="badge bg-info" target="_blank">Kwi. Cicilan 2</i></a>
                                                            <a href="" class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#hapus_bayar<?= $seragam['id_bayar']; ?>"><i class="fas fa-trash-alt"></i></a>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
    ...
    <div class="modal fade text-left" id="hapus_bayar<?= $seragam['id_bayar']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/hapus_pembayaran/') . $seragam['id_bayar']; ?>" method="POST">
