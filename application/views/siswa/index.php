        ...
        <div class="col-xl-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="pl-lg-4">
                        <div class="row">
                            <h4>Silahkan Klik Link Download Formulir untuk mencetak Formulir Pendaftaran <a href="<?= base_url('siswa/cetakform'); ?>" class="badge badge-info" target="_blank"><i class="fas fa-print"></i> Download </a></h4>
                        </div>
                    </div>
                    <hr class="my-4" />
                    <div class="pl-lg-4">
