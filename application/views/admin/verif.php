                                    ...
                                    <?php foreach ($siswa_baru as $sb) : ?>
                                        <?php if ($sb['status_verif'] == 'Belum') : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('admin/edit_verif/') . $sb['id_siswa']; ?>" class="badge bg-success"><i class="fas fa-check"></i></a>
                                                    <a href="<?= base_url('admin/akun_siswa/') . $sb['id_siswa']; ?>" class="badge bg-info"><i class="fas fa-users-cog"></i></a>
                                                    <a href="" class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#hapus_siswa<?= $sb['id_siswa']; ?>"><i class="fas fa-trash-alt"></i></a>
                                                    <a href="<?= base_url('admin/cetakform/') . $sb['id_siswa']; ?>" class="badge bg-warning" target="_blank"><i class="fas fa-print"></i></a>
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
        ...
        <div class="modal fade text-left" id="hapus_siswa<?= $sb['id_siswa']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('admin/hapus_siswa/') . $sb['id_siswa']; ?>" method="POST">
