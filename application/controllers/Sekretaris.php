...
class Sekretaris extends CI_Controller
{
    ...
    public function data_siswa()
    {
        ...
        $this->load->view('layout/admin_header', $data);
        $this->load->view('layout/admin_sidebar', $data);
        $this->load->view('sekretaris/detail_siswa', $data);
        $this->load->view('layout/admin_footer', $data);
    }
    ...
    public function edit_verif($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('layout/admin_header', $data);
            $this->load->view('layout/admin_sidebar', $data);
            $this->load->view('sekretaris/edit_verif', $data);
            $this->load->view('layout/admin_footer', $data);
        } else {
            $data = [
    ...
    public function akun_siswa($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('layout/admin_header', $data);
            $this->load->view('layout/admin_sidebar', $data);
            $this->load->view('sekretaris/akun_siswa', $data);
            $this->load->view('layout/admin_footer', $data);
        } else {
            $data = [
    ...
    public function cetakform($id)
    {
        ...
        $this->load->view('sekretaris/form_cetak', $data);
    }
    ...
    public function verif_du()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('layout/admin_header', $data);
            $this->load->view('layout/admin_sidebar', $data);
            $this->load->view('sekretaris/verif_du', $data);
            $this->load->view('layout/admin_footer', $data);
        } else {
    ...
    public function mpls()
    {
        ...
        $this->load->view('layout/admin_header', $data);
        $this->load->view('layout/admin_sidebar', $data);
        $this->load->view('sekretaris/mpls', $data);
        $this->load->view('layout/admin_footer', $data);
    }
    ...
    public function siswa_keluar()
    {
        ...
        $this->load->view('layout/admin_header', $data);
        $this->load->view('layout/admin_sidebar', $data);
        $this->load->view('sekretaris/siswa_keluar', $data);
        $this->load->view('layout/admin_footer', $data);
    }
}
