<div class="page-content">
    ...
    <form action="<?= base_url('bendahara/input_du'); ?>" method="POST">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if ($du['total_bayar'] >= $biaya_DU['nominal_du']) : ?>
                                                    ...
                                                    <a href="<?= base_url('bendahara/kwitansi_lunas/') . $du['id_bayar']; ?>" class="badge bg-info" target="_blank">Kwi. Lunas</i></a>
                                                    <a href="<?= base_url('bendahara/kwitansi_ci3/') . $du['id_bayar']; ?>" class="badge bg-info" target="_blank">Kwi. Cicilan 3</i></a>
                                                ...
                                                <?php elseif ($du['total_bayar'] <= $biaya_DU['nominal_du']) : ?>
                                                    <?php if ($du['cicilan_kedua'] == '0') : ?>
                                                        ...
                                                        <a href="<?= base_url('bendahara/cicilan2_du/') . $du['id_bayar']; ?>" class="badge bg-warning">Cicilan 2</a>
                                                        <a href="<?= base_url('bendahara/kwitansi_ci1/') . $du['id_bayar']; ?>" class="badge bg-info" target="_blank">Kwi. Cicilan 1</i></a>
                                                        <a href="" class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#hapus_bayar<?= $du['id_bayar']; ?>"><i class="fas fa-trash-alt"></i></a>
                                                    <?php elseif ($du['cicilan_ketiga'] == '0') : ?>
                                                        <span class="badge bg-secondary">Belum Lunas</span>
                                                        <a href="<?= base_url('bendahara/cicilan3_du/') . $du['id_bayar']; ?>" class="badge bg-warning">Cicilan 3</a>
                                                        <a href="<?= base_url('bendahara/kwitansi_ci2/') . $du['id_bayar']; ?>" class="badge bg-info" target="_blank">Kwi. Cicilan 2</i></a>
                                                        <a href="" class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#hapus_bayar<?= $du['id_bayar']; ?>"><i class="fas fa-trash-alt"></i></a>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </td>
    ...
    <div class="modal fade text-left" id="hapus_bayar<?= $du['id_bayar']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('bendahara/hapus_pembayaran/') . $du['id_bayar']; ?>" method="POST">
