                                    ...
                                    <?php foreach ($siswa_baru as $sb) : ?>
                                        <?php if ($sb['status_verif'] == 'Belum') : ?>
                                            <tr>
                                                ...
                                                <!-- <td>
                                                    <a href="<?= base_url('ketua/edit_verif/') . $sb['id_siswa']; ?>" class="badge bg-success"><i class="fas fa-check"></i></a>
                                                    <a href="<?= base_url('ketua/akun_siswa/') . $sb['id_siswa']; ?>" class="badge bg-info"><i class="fas fa-users-cog"></i></a>
        ...
        <div class="modal fade text-left" id="hapus_siswa<?= $sb['id_siswa']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('ketua/hapus_siswa/') . $sb['id_siswa']; ?>" method="POST">
